phase_info = {
    ...
    "climb_2": {
        ...
        "user_options": {
            ...
            "order": 3,
            "solve_for_distance": False,
            "initial_mach": (0.73, "unitless"),
            "final_mach": (0.73, "unitless"),
            "mach_bounds": ((0.72, 0.74), "unitless"),
            ...
            "duration_bounds": ((255.0, 765.0), "min"),
        },
        "initial_guesses": {"time": ([50.0, 510.0], "min")},
    },
    "descent_1": {
        "subsystem_options": {"core_aerodynamics": {"method": "computed"}},
        "user_options": {
