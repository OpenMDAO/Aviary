...
print(f'Fuel Mass = {prob.get_val(av.Mission.TOTAL_FUEL)[0]} lbm')
...
print(f'Fuel Mass = {prob_fallout.get_val(av.Mission.TOTAL_FUEL)[0]} lbm')
...
print(f'Fuel Mass = {prob_alternate.get_val(av.Mission.TOTAL_FUEL)[0]} lbm')
