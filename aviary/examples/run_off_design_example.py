...
print('--------------')
print(f'Design Range = {prob.get_val(av.Aircraft.Design.RANGE)[0]} nmi')
print(f'Mission Range = {prob.get_val(av.Mission.RANGE)[0]} nmi')
print(f'Fuel Mass = {prob.get_val(av.Mission.TOTAL_FUEL_MASS)[0]} lbm')
print(f'Operating Empty Mass = {prob.get_val(av.Mission.OPERATING_MASS)[0]} lbm')
print(f'Payload Mass = {prob.get_val(av.Aircraft.CrewPayload.TOTAL_PAYLOAD_MASS)[0]} lbm')
print(f'Design Gross Mass = {prob.get_val(av.Aircraft.Design.GROSS_MASS)[0]} lbm')
print(f'Mission Gross Mass = {prob.get_val(av.Mission.GROSS_MASS)[0]} lbm')

print('\n---------------')
print('Fallout Results')
print('---------------')
print(f'Design Range = {prob_fallout.get_val(av.Aircraft.Design.RANGE)[0]} nmi')
print(f'Mission Range = {prob_fallout.get_val(av.Mission.RANGE)[0]} nmi')
print(f'Fuel Mass = {prob_fallout.get_val(av.Mission.TOTAL_FUEL_MASS)[0]} lbm')
print(f'Operating Empty Mass = {prob_fallout.get_val(av.Mission.OPERATING_MASS)[0]} lbm')
print(f'Payload Mass = {prob_fallout.get_val(av.Aircraft.CrewPayload.TOTAL_PAYLOAD_MASS)[0]} lbm')
print(f'Design Gross Mass = {prob_fallout.get_val(av.Aircraft.Design.GROSS_MASS)[0]} lbm')
print(f'Mission Gross Mass = {prob_fallout.get_val(av.Mission.GROSS_MASS)[0]} lbm')

print('\n-----------------')
print('Alternate Results')
print('-----------------')
print(f'Design Range = {prob_alternate.get_val(av.Aircraft.Design.RANGE)[0]} nmi')
print(f'Mission Range = {prob_alternate.get_val(av.Mission.RANGE)[0]} nmi')
print(f'Fuel Mass = {prob_alternate.get_val(av.Mission.TOTAL_FUEL_MASS)[0]} lbm')
print(f'Operating Empty Mass = {prob_alternate.get_val(av.Mission.OPERATING_MASS)[0]} lbm')
print(f'Payload Mass = {prob_alternate.get_val(av.Aircraft.CrewPayload.TOTAL_PAYLOAD_MASS)[0]} lbm')
print(f'Design Gross Mass = {prob_alternate.get_val(av.Aircraft.Design.GROSS_MASS)[0]} lbm')
