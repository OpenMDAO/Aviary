...
class CellComp(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.declare_partials(
            of=Dynamic.Battery.VOLTAGE, wrt=Aircraft.Battery.N_PARALLEL
        )
        ...
        self.declare_partials(
            of=Dynamic.Battery.HEAT_OUT, wrt=Aircraft.Battery.N_PARALLEL
        )
        self.declare_partials(
            of=Dynamic.Battery.HEAT_OUT, wrt=Aircraft.Battery.N_SERIES
        )
        ...
        self.declare_partials(
            of=Dynamic.Battery.EFFICIENCY, wrt=Aircraft.Battery.N_PARALLEL
        )
        # self.declare_partials(of=Dynamic.Battery.EFFICIENCY, wrt=Aircraft.Battery.N_SERIES, rows=ar, cols=ar) # known 0
        self.declare_partials(
            of=Dynamic.Battery.EFFICIENCY, wrt='R_0', rows=ar, cols=ar
        )
        self.declare_partials(
            of=Dynamic.Battery.EFFICIENCY,
            wrt=Dynamic.Battery.VOLTAGE_THEVENIN,
        ...
        self.declare_partials(
            of=Dynamic.Battery.EFFICIENCY, wrt='U_oc', rows=ar, cols=ar
        )
    ...
    def compute(self, inputs, outputs):
        ...
        outputs[Dynamic.Battery.VOLTAGE_THEVENIN_RATE] = (
        ...
        outputs[Dynamic.Battery.EFFICIENCY] = 1.0 - outputs[
    ...
    def compute_partials(self, inputs, partials):
        ...
        partials[Dynamic.Battery.STATE_OF_CHARGE_RATE, Dynamic.Battery.CURRENT] = (
            -1.0 / (3600.0 * Q_max * n_p)
        )
        partials[Dynamic.Battery.STATE_OF_CHARGE_RATE, Aircraft.Battery.N_PARALLEL] = (
            I_pack / (3600.0 * Q_max * n_p**2)
        )
        partials[
            Dynamic.Battery.STATE_OF_CHARGE_RATE,
        ...
        partials[
            Dynamic.Battery.VOLTAGE_THEVENIN_RATE, Dynamic.Battery.VOLTAGE_THEVENIN
        ] = -1.0 / (R_Th * C_Th)
        partials[Dynamic.Battery.VOLTAGE_THEVENIN_RATE, 'R_Th'] = U_Th / (
            C_Th * R_Th**2
        )
        partials[Dynamic.Battery.VOLTAGE_THEVENIN_RATE, 'C_Th'] = (
            n_p * U_Th - I_pack * R_Th
        ) / (C_Th**2 * n_p * R_Th)
        partials[Dynamic.Battery.VOLTAGE_THEVENIN_RATE, Dynamic.Battery.CURRENT] = (
            1.0 / (C_Th * n_p)
        )
        partials[Dynamic.Battery.VOLTAGE_THEVENIN_RATE, Aircraft.Battery.N_PARALLEL] = (
            -I_pack / (C_Th * n_p**2)
        )
        ...
        partials[Dynamic.Battery.HEAT_OUT, Dynamic.Battery.VOLTAGE_THEVENIN] = (
            dQ_pack_dU_th
        )
        ...
        partials[Dynamic.Battery.EFFICIENCY, Aircraft.Battery.N_PARALLEL] = (
            dpack_eta__dnp
        )
        partials[Dynamic.Battery.EFFICIENCY, Dynamic.Battery.CURRENT] = (
            dpack_eta__dI_pack
        )
        partials[Dynamic.Battery.EFFICIENCY, 'R_0'] = dpack_eta__dR_0
        partials[Dynamic.Battery.EFFICIENCY, Dynamic.Battery.VOLTAGE_THEVENIN] = (
            dpack_eta__dU_t
        )
