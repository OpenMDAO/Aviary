...
if __name__ == '__main__':
    ...
    horizontal_tail = prob.model.dbf_horizontal_tail
    horizontal_tail.options['rib_materials'] = rib_materials
    horizontal_tail.options['airfoil_data_file'] = (
        r'aviary\examples\external_subsystems\dbf_based_mass\mh84-il.csv'
    )
    horizontal_tail.options['sheeting_coverage'] = (0.4, 'unitless')
    horizontal_tail.options['sheeting_density'] = (160, 'kg/m**3')
    horizontal_tail.options['sheeting_lightening_factor'] = (1, 'unitless')
    horizontal_tail.options['sheeting_thickness'] = (0.03125, 'inch')
    horizontal_tail.options['stringer_density'] = (160, 'kg/m**3')
    horizontal_tail.options['stringer_thickness'] = (0.375, 'inch')
    horizontal_tail.options['num_stringers'] = (2.5, 'unitless')
    horizontal_tail.options['glue_factor'] = (0.15, 'unitless')
    horizontal_tail.options['num_spars'] = (1.1, 'unitless')
    horizontal_tail.options['rib_lightening_factor'] = (2 / 3, 'unitless')
    horizontal_tail.options['rib_thicknesses'] = (rib_thicks, 'inch')
    horizontal_tail.options['skin_density'] = (20, 'g/m**2')
    horizontal_tail.options['spar_density'] = (2, 'g/cm**3')
    horizontal_tail.options['spar_outer_diameter'] = (1, 'inch')
    horizontal_tail.options['spar_wall_thickness'] = (0.0625, 'inch')
    ...
    print(f'Total mass of the dbf horizontal tail: {float(total_mass):.3f} kg')
