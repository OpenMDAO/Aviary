...
from aviary.models.external_subsystems.engine_NPSS.connected_variables import vars_to_connect
from aviary.models.external_subsystems.engine_NPSS.NPSS_Model.DesignEngineGroup import (
    DesignEngineGroup,
)
...
class NPSSTabularEngineBuilder(EngineModel):
    ...
    __init__(self, name='NPSS_prop_system', aviary_inputs=AviaryValues()):
        Initializes the NPSSTabularEngineBuilder object with a given name.
