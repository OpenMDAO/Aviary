...
class SimpleWeight(om.ExplicitComponent):
    """
    A simple component that compute a wing mass as a function of the engine mass.
    That values are not representative of any existing aircraft, and the component
