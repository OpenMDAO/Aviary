...
engine_1_inputs.set_val(Aircraft.Engine.CONSTANT_FUEL_MASS_CONSUMPTION, 0.0, units='lbm/h')
...
inputs.set_val(Aircraft.Wing.CHORD_PER_SEMISPAN_DISTRIBUTION, np.array([0.4441, 0.2313, 0.0729]))
...
inputs.set_val(Aircraft.Wing.INPUT_STATION_DISTRIBUTION, np.array([0.0, 0.3238, 1.0]))
