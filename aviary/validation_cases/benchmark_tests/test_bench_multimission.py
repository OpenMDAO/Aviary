...
class MultiMissionTestcase(unittest.TestCase):
    ...
    def test_multimission(self):
        ...
        objective_expected_value = 25672.61271768

        mission1_fuel = prob.get_val('mission1.mission:summary:fuel_burned', units='lbm')
        mission1_fuel_expected_value = 27050.67106054

        mission2_fuel = prob.get_val('mission2.mission:summary:fuel_burned', units='lbm')
        mission2_fuel_expected_value = 22916.49603196

        mission1_cargo = prob.get_val('mission1.aircraft:crew_and_payload:total_payload_mass', units='lbm')
        mission1_cargo_expected_value = 36477.

        mission2_cargo = prob.get_val('mission2.aircraft:crew_and_payload:total_payload_mass', units='lbm')
        mission2_cargo_expected_value = 4277.
