...
class ProblemPhaseTestCase(unittest.TestCase):
    ...
    def bench_test_sizing_N3CC(self):
        ...
        assert_near_equal(masses_descent[-1], expected_masses_kg_descent[-1], tolerance=rtol)

        # Range at the end of Descent
        assert_near_equal(distances_descent[-1], expected_distances_m_descent[-1], tolerance=rtol)

        # Flight time
        assert_near_equal(times_descent[-1], expected_times_s_descent[-1], tolerance=rtol)
