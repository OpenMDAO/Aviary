    ...
    def setup(self):
        ...
        self.add_subsystem(
            ...
            om.ExecComp(
                ...
                eff={'val': 1.0, 'units': 'unitless'},
                has_diag_partials=True,
            ),
            promotes_inputs=[
                ('shaft_power_in', Dynamic.Mission.SHAFT_POWER),
        ...
        self.add_subsystem(
            ...
            promotes_inputs=[
                ('shaft_power_out', Dynamic.Mission.SHAFT_POWER_GEARBOX),
        ...
        self.add_subsystem(
            ...
            promotes_inputs=[
                ('shaft_power_in', Dynamic.Mission.SHAFT_POWER_MAX),
                ('eff', Aircraft.Engine.Gearbox.EFFICIENCY),
            ],
            promotes_outputs=[
                ('shaft_power_out', Dynamic.Mission.SHAFT_POWER_MAX_GEARBOX)
            ],
        )
