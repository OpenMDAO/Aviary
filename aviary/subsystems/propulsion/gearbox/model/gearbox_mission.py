...
class GearboxMission(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            'shaft_power_comp',
            om.ExecComp(
                'shaft_power_out = shaft_power_in * eff',
            ...
            promotes_inputs=[
                ('shaft_power_in', Dynamic.Vehicle.Propulsion.SHAFT_POWER),
                ('eff', Aircraft.Engine.Gearbox.EFFICIENCY),
            ],
            promotes_outputs=[
                ('shaft_power_out', Dynamic.Vehicle.Propulsion.SHAFT_POWER_GEARBOX)
            ],
        )
        ...
        self.add_subsystem(
            ...
            promotes_outputs=[
                ('torque_out', Dynamic.Vehicle.Propulsion.TORQUE_GEARBOX)
            ],
        )
        ...
        self.add_subsystem(
            ...
            promotes_inputs=[
                ('shaft_power_in', Dynamic.Vehicle.Propulsion.SHAFT_POWER_MAX),
                ('eff', Aircraft.Engine.Gearbox.EFFICIENCY),
            ],
            promotes_outputs=[
                ('shaft_power_out', Dynamic.Vehicle.Propulsion.SHAFT_POWER_MAX_GEARBOX)
            ],
        )
