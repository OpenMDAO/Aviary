...
options = options
options.set_val(Aircraft.Battery.VOLTAGE, 22.2, units='V')
options.set_val(Aircraft.Battery.RESISTANCE, 0.05, units='ohm')
options.set_val(Dynamic.Vehicle.Propulsion.THROTTLE, np.linspace(0, 1, nn))
options.set_val(Aircraft.Engine.Motor.IDLE_CURRENT, 0.91, units='A')
options.set_val(Aircraft.Engine.Motor.PEAK_CURRENT, 120, units='A')
options.set_val(Aircraft.Engine.Motor.RESISTANCE, 0.032, units='ohm')
options.set_val(Aircraft.Engine.Motor.KV, 420, units='rpm/V')
options.set_val(Dynamic.Atmosphere.DENSITY, 1.225, units='kg/m**3')
options.set_val(Aircraft.Engine.Propeller.DIAMETER, 20, units='inch')
options.set_val(Aircraft.Engine.Propeller.PITCH, 10, units='inch')
options.set_val(Aircraft.Engine.NUM_ENGINES, [1])
# options.set_val(Dynamic.Mission.VELOCITY, 20, units='ft/s')
...
prob.model = PropulsionMission(
    num_nodes=nn, aviary_options=options, engine_models=[RCBuilder]
)
...
#         options.set_val(Aircraft.Engine.Propeller.DIAMETER, 20, units='inch')
#         options.set_val(Aircraft.Engine.Propeller.PITCH, 10, units='inch')
#         options.set_val(Aircraft.Engine.NUM_ENGINES, 1, units='unitless')
#         # options.set_val(Dynamic.Mission.VELOCITY, 20, units='ft/s')
#         # options.set_val(Aircraft.Engine.DATA_FILE, filename)
#         # options.set_val(Aircraft.Engine.GLOBAL_THROTTLE, True)
#         # options.set_val(Aircraft.Engine.NUM_ENGINES, 1)
