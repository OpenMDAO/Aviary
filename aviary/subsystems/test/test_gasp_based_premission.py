...
class BWBPreMissionGroupTest(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        assert_near_equal(prob[Aircraft.Wing.HIGH_LIFT_MASS], 973.52470181, tol)
        ...
        assert_near_equal(prob[Aircraft.Wing.FOLD_MASS], 107.85962312, tol)
        assert_near_equal(prob[Aircraft.Wing.MASS], 6961.41136144, tol)
        assert_near_equal(prob[Aircraft.Fuel.FUEL_SYSTEM_MASS], 1316.16748164, tol)
        ...
        assert_near_equal(prob[Mission.Summary.FUEL_MASS_REQUIRED], 34186.16835418, tol)
        assert_near_equal(prob[Aircraft.Propulsion.MASS], 8627.6738, tol)
        assert_near_equal(prob[Mission.Summary.FUEL_MASS], 34186.16835418, tol)
        assert_near_equal(prob[Aircraft.Fuel.WING_VOLUME_DESIGN], 751.76125834, tol)
        assert_near_equal(prob[Mission.Summary.OPERATING_MASS], 82063.412, tol)
        assert_near_equal(prob[Aircraft.Fuel.AUXILIARY_FUEL_CAPACITY], 3877.29959048, tol)
