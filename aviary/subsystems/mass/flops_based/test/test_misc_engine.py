...
class MiscEngineMassTest(unittest.TestCase):
    ...
    def test_case_multiengine(self):
        ...
        prob.model.add_subsystem('misc_engine_mass', EngineMiscMass(**comp_options), promotes=['*'])

        prob.setup(force_alloc_complex=True)

        prob.set_val(Aircraft.Engine.ADDITIONAL_MASS, np.array([100, 26, 30]), units='lbm')
...
@use_tempdirs
class BWBMiscEngineMassTest(unittest.TestCase):
    """Tests misc engine mass calculation for BWB."""
