...
class DistributedPropulsionFactorsTest():
    def setUp(self):
        pass

    def xxxnoruncase_dist_eng_count(self):
        tol = 1e-12
    ...
    def xxxnoruncase_dist_thrust(self):
        tol = 1e-12
        max_thrust = 10000.0
    ...
    def xxxnoruncase_dist_nacelle_diam(self):
        tol = 1e-12
        diam_nacelle = 10.0
    ...
    def xxxnoruncase_dist_nacelle_diam_deriv(self):
        tol = 1e-12
