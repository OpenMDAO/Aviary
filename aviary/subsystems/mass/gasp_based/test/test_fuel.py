...
class FuelAndOEMTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(Mission.USEFUL_LOAD, val=4932.0, units='lbm')
        self.prob.model.set_input_defaults('fuel_mass_required', val=42892.0, units='lbm')
        self.prob.model.set_input_defaults(
...
class FuelAndOEMTestCase2(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        prob.model.set_input_defaults(Mission.USEFUL_LOAD, val=4932.0, units='lbm')
...
class FuelMassGroupTestCase1(unittest.TestCase):
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(Mission.USEFUL_LOAD, val=4932, units='lbm')
        self.prob.model.set_input_defaults(
...
class FuelMassGroupTestCase2(
    ...
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(Mission.USEFUL_LOAD, val=4885.18, units='lbm')
        self.prob.model.set_input_defaults(
    ...
    def test_case1(self):
        ...
        assert_near_equal(self.prob[Mission.OPERATING_MASS], 94417.0, tol)
        ...
        # fuel
        assert_near_equal(self.prob['fuel_mass'], 44982.7, tol)
        assert_near_equal(self.prob[Aircraft.Propulsion.MASS], 16399.0, tol)
        assert_near_equal(self.prob['fuel_mass_required'], 44982.7, tol)
...
class FuelMassGroupTestCase3(unittest.TestCase):  # this is v 3.6 advanced tube and wing case
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(Mission.USEFUL_LOAD, val=4701, units='lbm')
        self.prob.model.set_input_defaults(
    ...
    def test_case1(self):
        ...
        assert_near_equal(self.prob[Mission.OPERATING_MASS], 82961.0, tol)
        ...
        # fuel
        assert_near_equal(self.prob['fuel_mass'], 31627.2, tol)
        assert_near_equal(self.prob[Aircraft.Propulsion.MASS], 10755.0, tol)
        assert_near_equal(self.prob['fuel_mass_required'], 31627, tol)
...
class BWBFuelMassTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        prob.model.set_input_defaults(Mission.USEFUL_LOAD, 4156.795, units='lbm')
...
class BWBFuelMassGroupTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        prob.model.set_input_defaults(Mission.USEFUL_LOAD, 5775, units='lbm')
        prob.model.set_input_defaults('payload_mass_des', 33750.0, units='lbm')
        prob.model.set_input_defaults(Aircraft.Fuel.FUEL_SYSTEM_MASS_SCALER, 1.0, units='unitless')
        prob.model.set_input_defaults(
            Aircraft.Fuel.FUEL_SYSTEM_MASS_COEFFICIENT, 0.035, units='unitless'
    ...
    def test_case1(self):
        ...
        # wingfuel
        assert_near_equal(self.prob[Mission.OPERATING_MASS], 82252.59837521, tol)
        ...
        # fuel
        assert_near_equal(self.prob['fuel_mass'], 33997.40162479, tol)
        assert_near_equal(self.prob[Aircraft.Propulsion.MASS], 8620.39996255, tol)
        assert_near_equal(self.prob['fuel_mass_required'], 33997.40162479, tol)
