...
class NewEngineTestCase1(unittest.TestCase):  # this is the large single aisle 1 V3 test case
    def setUp(self):
        options = get_option_defaults()
        options.set_val(Aircraft.Electrical.HAS_HYBRID_SYSTEM, val=False, units='unitless')
        options.set_val(Aircraft.Engine.ADDITIONAL_MASS_FRACTION, 0.14)
...
class WingMountEngineTestCase1(unittest.TestCase):  # this is the large single aisle 1 V3 test case
    ...
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(Aircraft.Engine.POD_MASS, val=1892.24386333, units='lbm')
...
class NewEngineTestCase2(unittest.TestCase):
    def setUp(self):
        options = get_option_defaults()
        options.set_val(Aircraft.Engine.ADDITIONAL_MASS_FRACTION, 0.14)
        options.set_val(Aircraft.Electrical.HAS_HYBRID_SYSTEM, val=True, units='unitless')
...
class WingMountEngineTestCase2(unittest.TestCase):
...
class NewEngineTestCase3(unittest.TestCase):
    def setUp(self):
        options = get_option_defaults()
        options.set_val(Aircraft.Engine.ADDITIONAL_MASS_FRACTION, 0.14)
        options.set_val(Aircraft.Electrical.HAS_HYBRID_SYSTEM, val=True, units='unitless')
...
class WingMountEngineTestCase3(unittest.TestCase):
...
class NewEngineGroupTestCase1(unittest.TestCase):
    """HAS_HYBRID_SYSTEM = False (large single aisle 1 V3)"""
...
class NewEngineGroupTestCase2(unittest.TestCase):
    """HAS_HYBRID_SYSTEM = False (large single aisle 1 V3)"""
...
# arbitrary test case with multiple engine types
@use_tempdirs
class NewEngineTestCaseMultiEngine(unittest.TestCase):
    def test_case1(self):
        options = get_option_defaults()
        options.set_val(Aircraft.Electrical.HAS_HYBRID_SYSTEM, val=False, units='unitless')
...
class WingMountEngineTestCaseMultiEngine(unittest.TestCase):
    def test_case1(self):
        options = get_option_defaults()
        options.set_val(Aircraft.Electrical.HAS_HYBRID_SYSTEM, val=False, units='unitless')
...
class HighLiftTestCase(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        data = self.prob.check_partials(out_stream=None, method='cs', show_only_incorrect=True)
...
class GearTestCaseMultiengine(unittest.TestCase):
    def test_case1(self):
        ...
        self.prob.model.set_input_defaults(Aircraft.LandingGear.MAIN_GEAR_MASS_FRACTION, val=0.85)
...
# this is the large single aisle 1 V3 test case
@use_tempdirs
class NewFixedMassGroupTestCase1(unittest.TestCase):
    def setUp(self):
        options = get_option_defaults()
        options.set_val(Aircraft.Electrical.HAS_HYBRID_SYSTEM, val=False, units='unitless')
        options.set_val(Aircraft.CrewPayload.NUM_PASSENGERS, val=180, units='unitless')
...
@use_tempdirs
class NewFixedMassGroupTestCase2(unittest.TestCase):
    def setUp(self):
        options = get_option_defaults()
        options.set_val(Aircraft.CrewPayload.NUM_PASSENGERS, val=180, units='unitless')
        options.set_val(Aircraft.CrewPayload.Design.NUM_PASSENGERS, val=180, units='unitless')
        ...
        data = AviaryValues(
            {
                ...
                Aircraft.Engine.Propeller.MASS: (0.5, 'lbm'),
                ...
                Aircraft.LandingGear.MAIN_GEAR_MASS_FRACTION: (1.16, 'unitless'),
...
@use_tempdirs
class NewFixedMassGroupTestCase3(unittest.TestCase):
    # Tests partials calculations in FixedMassGroup using as complete code coverage as possible.
