...
from aviary.subsystems.mass.gasp_based.design_load import (DesignLoadGroup,
                                                           ...
                                                           LoadSpeeds)
from aviary.subsystems.mass.gasp_based.design_load import BWBLoadSpeeds
...
class BWBLoadSpeedsTestCATD3(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        tol = 1e-8
        assert_near_equal(self.prob["max_airspeed"], 350.0, tol)  # bug fixed value
        assert_near_equal(self.prob["vel_c"], 350.0, tol)  # bug fixed value
        assert_near_equal(self.prob["max_maneuver_factor"], 2.5, tol)  # bug fixed value
        assert_near_equal(self.prob["min_dive_vel"], 420.0, tol)  # bug fixed value
