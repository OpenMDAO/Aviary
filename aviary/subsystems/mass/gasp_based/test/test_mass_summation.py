...
class MassSummationTestCase1(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        # wing values:
        assert_near_equal(
            self.prob["total_mass.wing_mass.isolated_wing_mass"], 15758, tol)
        ...
        # 102408.05695930264
        assert_near_equal(
            self.prob["total_mass.fuel_mass.fus_mass_full"], 102408.4, tol
        )
        # modified from GASP value to account for updated crew mass. GASP value is
        # 1757
        assert_near_equal(
        ...
        assert_near_equal(
            self.prob["total_mass.fuel_mass.max_wingfuel_mass"], 57066.3, tol)
        assert_near_equal(
...
class MassSummationTestCase2(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # )
        self.prob.model.set_input_defaults(
            Aircraft.Engine.SCALE_FACTOR, 1.02823, units='unitless')
        self.prob.model.set_input_defaults(
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Design.APU_MASS, val=928.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.INSTRUMENT_MASS_COEFFICIENT, val=0.0736, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Design.HYDRAULICS_FC_MASS_COEFFICIENT, val=0.112, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Design.HYDRAULICS_GEAR_MASS_COEFFICIENT, val=0.14, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Design.AVIONICS_MASS, val=1959.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.AIR_CONDITION_MASS_COEFFICIENT, val=1.65, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Design.ANTI_ICING_MASS, val=551.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.FURNISHINGS_MASS, val=11192.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.PAX_SERVICE_MASS_PER_PASSENGER, val=5.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.WATER_MASS_PER_OCCUPANT, val=3.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.EMERGENCY_MASS, val=50.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.CATERING_ITEMS_MASS_PER_PASSENGER, val=7.6, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.UNUSABLE_FUEL_MASS_COEFFICIENT, val=12.0, units="unitless")
    ...
    def test_case1(self):
        ...
        assert_near_equal(
            self.prob["fuel_mass.fuel_and_oem.volume_wingfuel_mass"], 55725.1, tol
        )
...
class MassSummationTestCase5(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Wing.LOADING, val=150, units="lbf/ft**2"
        )
        self.prob.model.set_input_defaults(
            Aircraft.HorizontalTail.VERTICAL_TAIL_FRACTION, val=0, units="unitless"
        )
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Fuel.FUEL_MARGIN, val=0.0, units="unitless"
        )
    ...
    def test_case1(self):
        ...
        assert_near_equal(
            self.prob["fuel_mass.fus_mass_full"], 102510.7, tol
        )  # calculated by hand
        assert_near_equal(
        ...
        assert_near_equal(
            self.prob["fuel_mass.fuel_and_oem.volume_wingfuel_mass"], 43852.1, tol
        )
...
class MassSummationTestCase6(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Fuel.FUEL_MARGIN, val=10.0, units="unitless"
        )
    ...
    def test_case1(self):
        ...
        assert_near_equal(
            self.prob["fuel_mass.fus_mass_full"], 106913.6, tol
        )  # calculated by hand
        assert_near_equal(
...
class MassSummationTestCase7(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Wing.ASPECT_RATIO, val=11, units="unitless"
        )
        self.prob.model.set_input_defaults(
            Aircraft.Wing.TAPER_RATIO, val=0.33, units="unitless"
        )
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Wing.LOADING, val=104.50, units="lbf/ft**2"
        )
        self.prob.model.set_input_defaults(
            Aircraft.HorizontalTail.VERTICAL_TAIL_FRACTION, val=0, units="unitless"
        )
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Engine.REFERENCE_DIAMETER, 7.36, units="ft")
        # self.prob.model.set_input_defaults(
        #     Aircraft.Engine.REFERENCE_SLS_THRUST, 28620.0, units="lbf"
        # )
        self.prob.model.set_input_defaults(
            Aircraft.Engine.SCALE_FACTOR, 0.594, units='unitless'
        )
        self.prob.model.set_input_defaults(
            Aircraft.Nacelle.CORE_DIAMETER_RATIO, 1.2095, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Nacelle.FINENESS, 1.715, units="unitless")
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Design.APU_MASS, val=1014.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.INSTRUMENT_MASS_COEFFICIENT, val=0.0736, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Design.HYDRAULICS_FC_MASS_COEFFICIENT, val=0.085, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Design.HYDRAULICS_GEAR_MASS_COEFFICIENT, val=0.105, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Design.AVIONICS_MASS, val=1504.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.AIR_CONDITION_MASS_COEFFICIENT, val=1.65, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Design.ANTI_ICING_MASS, val=126.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.FURNISHINGS_MASS, val=9114.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.PAX_SERVICE_MASS_PER_PASSENGER, val=5.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.WATER_MASS_PER_OCCUPANT, val=3.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.EMERGENCY_MASS, val=0.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.CATERING_ITEMS_MASS_PER_PASSENGER, val=10.0, units="lbm")
        self.prob.model.set_input_defaults(
            Aircraft.Design.UNUSABLE_FUEL_MASS_COEFFICIENT, val=12.0, units="unitless")
    ...
    def test_case1(self):
        ...
        assert_near_equal(
            self.prob[Aircraft.HorizontalTail.AVERAGE_CHORD], 9.6498, tol
            # note: value came from running the GASP code on my own and printing it out (GASP output calculates this differently)
        )
        assert_near_equal(
            self.prob[Aircraft.VerticalTail.AVERAGE_CHORD], 13.4662, tol
            # note: value came from running the GASP code on my own and printing it out (GASP output calculates this differently)
        )
        ...
        assert_near_equal(
            self.prob["fuel_mass.fuel_and_oem.volume_wingfuel_mass"], 33892.8, tol
        )
...
class MassSummationTestCase8(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Engine.REFERENCE_DIAMETER, 7.642, units="ft")
        # self.prob.model.set_input_defaults(
        #     Aircraft.Engine.REFERENCE_SLS_THRUST, 28620.0, units="lbf"
        # )
        self.prob.model.set_input_defaults(
            Aircraft.Engine.SCALE_FACTOR, 1.35255, units='unitless'
        )
        self.prob.model.set_input_defaults(
            Aircraft.Nacelle.CORE_DIAMETER_RATIO, 1.2095, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Nacelle.FINENESS, 1.660, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Fuselage.DELTA_DIAMETER, 4.5, units="ft"
        )
        self.prob.model.set_input_defaults(
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Engine.SCALE_FACTOR, 0.73934, units='unitless'
        )
        self.prob.model.set_input_defaults(
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Fuel.FUEL_SYSTEM_MASS_SCALER, val=1, units="unitless")
        self.prob.model.set_input_defaults(
            Mission.Design.GROSS_MASS, val=143100.0, units="lbm"
        )
        self.prob.model.set_input_defaults(
            Aircraft.Wing.MASS_COEFFICIENT, val=78.94, units="unitless"
        )
        self.prob.model.set_input_defaults(
            Aircraft.Wing.TAPER_RATIO, val=0.346, units="unitless"
        )
        self.prob.model.set_input_defaults(
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Strut.MASS_COEFFICIENT, 0.238, units="unitless"
        )
    ...
    def test_case1(self):
        ...
        assert_near_equal(
            self.prob["fuel_mass.fuel_and_oem.volume_wingfuel_mass"], 31051.6, tol
        )
...
class MassSummationTestCase9(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Engine.REFERENCE_DIAMETER, 8.425, units="ft")
        # self.prob.model.set_input_defaults(
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Nacelle.CORE_DIAMETER_RATIO, 1.2095, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Nacelle.FINENESS, 1.569, units="unitless")
        self.prob.model.set_input_defaults(
            Aircraft.Fuselage.DELTA_DIAMETER, 4.5, units="ft"
        )
        self.prob.model.set_input_defaults(
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Engine.SCALE_FACTOR, 0.82984, units='unitless'
        )
        self.prob.model.set_input_defaults(
        ...
        self.prob.model.set_input_defaults(
            Aircraft.Fuel.FUEL_SYSTEM_MASS_SCALER, val=1, units="unitless")
        self.prob.model.set_input_defaults(
            Mission.Design.GROSS_MASS, val=166100.0, units="lbm"
        )
        self.prob.model.set_input_defaults(
            Aircraft.Wing.MASS_COEFFICIENT, val=78.94, units="unitless"
        )
        ...
        self.prob.model.set_input_defaults(
            "fixed_mass.augmentation.motor_power", 830, units="kW"
        )
        self.prob.model.set_input_defaults(
            "fixed_mass.augmentation.motor_voltage", 850, units="V"
        )
        self.prob.model.set_input_defaults(
    ...
    def test_case1(self):
        ...
        assert_near_equal(
            self.prob["fuel_mass.fuel_and_oem.volume_wingfuel_mass"], 35042.1, tol
        )
