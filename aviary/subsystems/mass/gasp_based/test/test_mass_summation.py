...
class MassSummationTestCase1(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        expected_values = {
            ...
            'OEM_wingfuel_mass': 79500.16001078,  # modified from GASP value to account for updated crew mass. GASP value is 78843.6
            'fus_mass_full': 101735.01012115,  # modified from GASP value to account for updated crew mass. GASP value is 102408.05695930264
            Aircraft.Fuel.FUEL_SYSTEM_MASS: 1783.50656044,  # modified from GASP value to account for updated crew mass. GASP value is 1757
            ...
            Mission.Summary.FUEL_MASS_REQUIRED: 43500.16001078,  # modified from GASP value to account for updated crew mass. GASP value is 42843.6
            Aircraft.Propulsion.MASS: 16161.21,  # modified from GASP value to account for updated crew mass. GASP value is 16127
            Mission.Summary.FUEL_MASS: 43500.16001078,  # modified from GASP value to account for updated crew mass. GASP value is 42844.0
            'fuel_mass_min': 33460.16001078,  # modified from GASP value to account for updated crew mass. GASP value is 32803.6
            Aircraft.Fuel.WING_VOLUME_DESIGN: 869.61632311,  # modified from GASP value to account for updated crew mass. GASP value is 856.4910800459031
            'OEM_fuel_vol': 1589.29615013,  # modified from GASP value to account for updated crew mass. GASP value is 1576.1710061411081
            Mission.Summary.OPERATING_MASS: 95899.83998922,  # modified from GASP value to account for updated crew mass. GASP value is 96556.0
...
class BWBMassSummationTestCase(unittest.TestCase):
    ...
    def test_case1(self):
        ...
        assert_near_equal(prob[Aircraft.Engine.POSITION_FACTOR], 1.05, tol)
        assert_near_equal(prob[Aircraft.Design.SYSTEMS_AND_EQUIPMENT_MASS], 20876.477, tol)
        assert_near_equal(prob[Mission.Summary.USEFUL_LOAD], 5971.79463002, tol)
