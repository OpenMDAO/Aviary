...
from aviary.interface.default_phase_info.simple import aero, prop, geom
...
class MissionDragTest(unittest.TestCase):
    ...
    def test_basic_large_single_aisle_1(self):
        ...
        # 1D Tables over M
        # ---------------------
        mach = np.array([0.200, 0.300, 0.400, 0.500, 0.600, 0.700,
                        0.750, 0.775, 0.800, 0.825, 0.850, 0.875])
        CL = np.array([0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45,
        ...
        assert_near_equal(CD, data, .05)

        assert_near_equal(CD[:134], data[:134], .004)
    ...
    def test_n3cc_drag(self):
        ...
        # 1D Tables over M
        # ---------------------
        mach = np.array([0.200, 0.300, 0.400, 0.500, 0.600,
                        0.700, 0.750, 0.775, 0.800, 0.825, 0.850])
        CL = np.array([0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5,
        ...
        assert_near_equal(CD[:134], data[:134], .005)
    ...
    def test_large_single_aisle_2_drag(self):
        ...
        # 1D Tables over M
        # ---------------------
        mach = np.array([0.2, 0.300, 0.400, 0.500, 0.600, 0.700,
                        0.750, 0.775, 0.800, 0.825, 0.850])
        CL = np.array([0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4,
