...
class LiftDependentDrag(om.ExplicitComponent):
    ...
    def edge_interp(self, A1, A2, FCDP1, FCDP2, dFCDP1, dFCDP2, A):
        ...
        dFCDP_dDEL = (
            ...
            * den
            * (
                dFCDP1 * (FCDP2 - FCDP1 * FCDP2 * den * (A - A1))
    ...
    def inner_interp(
        ...
        interp_arrdFCDP_dDELM = InterpND(method='lagrange2', points=(arrA), values=arrdFCDP_dDELM)
        dFCDP_dDELM, deriv = interp_arrdFCDP_dDELM.interpolate(A, compute_derivative=True)  # at A
        ...
        interp_arrdFCDP_dDELCL = InterpND(method='lagrange2', points=(arrA), values=arrdFCDP_dDELCL)
        dFCDP_dDELCL, deriv = interp_arrdFCDP_dDELCL.interpolate(A, compute_derivative=True)  # at A
...
AR05 = np.array(
    [
        [
            11010, -0.400000, -0.300000, -0.200000, -0.100000,
            -0.050000, 0.000000, 0.050000, 0.100000, 0.200000, 0.300000
        ],
        [
        ...
        [
            0.050000, 0.002400, 0.000400, 0.002400, 0.003200, 0.004900,
            0.010000, 0.019000, 0.034000, 0.100000, 0.175000
        ]
    ]
)
...
AR1 = np.array(
    [
        [
            11010, -0.400000, -0.300000, -0.200000, -0.100000, -0.050000,
        ...
        [
            0.050000, 0.003000, 0.000500, 0.003000, 0.004750, 0.009300,
            0.016000, 0.026000, 0.037500, 0.074000, 0.141000,
        ],
    ]
)
...
AR2 = np.array(
    [
        ...
        [
            0.050000, 0.003700, 0.000700, 0.003700, 0.008800, 0.013500,
            0.021000, 0.029000, 0.037000, 0.060000, 0.090000,
        ],
    ]
)
...
AR4 = np.array(
    [
        ...
        [
            0.050000, 0.004400, 0.000600, 0.004400, 0.011300, 0.018100,
            0.024000, 0.031000, 0.038000, 0.051000, 0.064000,
        ],
    ]
)
...
AR6 = np.array(
    [
        [
            11009, -0.400000, -0.300000, -0.200000, -0.100000,
            -0.050000, 0.000000, 0.050000, 0.100000, 0.200000,
        ],
        [
        ...
        [
            0.050000, 0.003900, 0.000520, 0.003900, 0.011500,
            0.016000, 0.027000, 0.037000, 0.047000, 0.068000,
        ],
    ]
)
...
ARS07 = np.array(
    [
        [
            9010, -0.400000, -0.300000, -0.200000, -0.100000, -0.050000,
            0.000000, 0.050000, 0.100000, 0.200000, 0.300000,
        ],
        [
        ...
        [
            1.100000, 0.003400, 0.000800, 0.003400, 0.020000, 0.042500,
            0.074000, 0.130000, 0.200000, 0.380000, 0.700000,
        ],
    ]
)
...
ARS08 = np.array(
    [
        ...
        [
            1.100000, 0.000000, 0.001000, 0.007000, 0.026000, 0.051000,
            0.080000, 0.135000, 0.200000, 0.320000, 0.520000,
        ],
    ]
)
...
ARS10 = np.array(
    [
        ...
        [
            1.100000, 0.000000, 0.002200, 0.012300, 0.038000, 0.065500,
            0.100000, 0.136000, 0.176000, 0.270000, 0.450000,
        ],
    ]
)
...
ARS12 = np.array(
    [
        ...
        [
            1.100000, 0.000000, 0.002200, 0.017000, 0.045000, 0.073000,
            0.101000, 0.133500, 0.165000, 0.300000, 0.600000,
        ],
    ]
)
...
ARS14 = np.array(
    [
        ...
        [
            1.100000, 0.000000, 0.002500, 0.018500, 0.047500, 0.074000,
            0.101000, 0.129000, 0.155000, 0.300000, 0.550000,
        ],
    ]
)
...
ARS16 = np.array(
    [
        ...
        [
            1.100000, 0.000000, 0.003000, 0.022000, 0.048000, 0.076000,
            0.102000, 0.129000, 0.154000, 0.300000, 0.490000,
        ],
    ]
)
...
ARS18 = np.array(
    [
        ...
        [
            1.100000, 0.000000, 0.003000, 0.022000, 0.048500, 0.076500,
            0.104000, 0.130000, 0.155000, 0.302000, 0.440000,
        ],
    ]
)
...
ARS20 = np.array(
    [
        ...
        [
            1.100000, 0.000000, 0.003600, 0.022000, 0.048000, 0.075000,
            0.102000, 0.128000, 0.155000, 0.269000, 0.375000,
        ],
    ]
)
# fmt: on
...
AR05table = InterpND(
    method='lagrange2', points=(AR05[1:, 0], AR05[0, 1:]), values=AR05[1:, 1:], extrapolate=True
)
AR1table = InterpND(
    method='lagrange2', points=(AR1[1:, 0], AR1[0, 1:]), values=AR1[1:, 1:], extrapolate=True
)
AR2table = InterpND(
    method='lagrange2', points=(AR2[1:, 0], AR2[0, 1:]), values=AR2[1:, 1:], extrapolate=True
)
AR4table = InterpND(
    method='lagrange2', points=(AR4[1:, 0], AR4[0, 1:]), values=AR4[1:, 1:], extrapolate=True
)
AR6table = InterpND(
    method='lagrange2', points=(AR6[1:, 0], AR6[0, 1:]), values=AR6[1:, 1:], extrapolate=True
)
ARS07table = InterpND(
    method='lagrange2', points=(ARS07[1:, 0], ARS07[0, 1:]), values=ARS07[1:, 1:], extrapolate=True
)
ARS08table = InterpND(
    method='lagrange2', points=(ARS08[1:, 0], ARS08[0, 1:]), values=ARS08[1:, 1:], extrapolate=True
)
ARS10table = InterpND(
    method='lagrange2', points=(ARS10[1:, 0], ARS10[0, 1:]), values=ARS10[1:, 1:], extrapolate=True
)
ARS12table = InterpND(
    method='lagrange2', points=(ARS12[1:, 0], ARS12[0, 1:]), values=ARS12[1:, 1:], extrapolate=True
)
ARS14table = InterpND(
    method='lagrange2', points=(ARS14[1:, 0], ARS14[0, 1:]), values=ARS14[1:, 1:], extrapolate=True
)
ARS16table = InterpND(
    method='lagrange2', points=(ARS16[1:, 0], ARS16[0, 1:]), values=ARS16[1:, 1:], extrapolate=True
)
ARS18table = InterpND(
    method='lagrange2', points=(ARS18[1:, 0], ARS18[0, 1:]), values=ARS18[1:, 1:], extrapolate=True
)
ARS20table = InterpND(
    method='lagrange2', points=(ARS20[1:, 0], ARS20[0, 1:]), values=ARS20[1:, 1:], extrapolate=True
)
