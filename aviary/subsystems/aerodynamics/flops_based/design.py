...
AMDES = np.array(
    [
        [8003, 0.180, 0.240, 0.300],
        [0.10, -0.2080, -0.3330, -0.4590],
        [0.20, -0.2180, -0.3430, -0.4680],
        [0.30, -0.2290, -0.3530, -0.4780],
        [0.40, -0.2420, -0.3650, -0.4880],
        [0.50, -0.2580, -0.3770, -0.4950],
        [0.60, -0.2710, -0.3880, -0.5070],
        [0.70, -0.2940, -0.4130, -0.5300],
        [0.80, -0.3170, -0.4310, -0.5460],
    ]
)
...
AMDEStable = InterpND(
    method='slinear', points=(AMDES[1:, 0], AMDES[0, 1:]), values=AMDES[1:, 1:], extrapolate=True
)
CMDEStable = InterpND(
    method='slinear', points=(CMDES[1:, 0], CMDES[0, 1:]), values=CMDES[1:, 1:], extrapolate=True
)
