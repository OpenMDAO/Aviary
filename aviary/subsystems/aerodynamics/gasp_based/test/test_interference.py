...
class TestPreMissionSubComponents(unittest.TestCase):
    def test_root_chord(self):
        ...
        prob.set_val(Aircraft.Wing.TAPER_RATIO, 0.9)
    ...
    def test_common_vars(self):
        ...
        prob.set_val(Aircraft.Wing.VERTICAL_MOUNT_LOCATION, 0.1)
        prob.set_val(Aircraft.Wing.THICKNESS_TO_CHORD_ROOT, 0.12)
    ...
    def test_body_ratios(self):
        ...
        prob.set_val(Aircraft.Wing.TAPER_RATIO, 0.9)
        prob.set_val(Aircraft.Wing.THICKNESS_TO_CHORD_ROOT, 0.12)
        prob.set_val(Aircraft.Wing.THICKNESS_TO_CHORD_TIP, 0.1)
    ...
    def test_interference_drag(self):
        ...
        prob.set_val('WBODYWF', 2.5)
        prob.set_val('CROOT', 12)
        prob.set_val('TCBODYWF', 0.1)
        prob.set_val('CBODYWF', 12)
        prob.set_val('ZW_RF', 0.5)
        prob.set_val(Aircraft.Fuselage.AVG_DIAMETER, 10)
        prob.set_val(Aircraft.Wing.CENTER_DISTANCE, 0.6)
...
class TestMission(unittest.TestCase):
    def test_complete_group(self):
        ...
        prob.set_val(Dynamic.Atmosphere.MACH, (0.6, 0.65))
