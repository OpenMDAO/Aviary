...
class LiftAndDragIncrements(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        add_aviary_input(self, Aircraft.Wing.FLAP_DRAG_INCREMENT_OPTIMUM, units='unitless')
        self.add_input(
            'VDEL1',
            val=1.0,
            units='unitless',
        ...
        self.add_output(
            'delta_CD', val=0.0, desc='DCD: increment on drag coefficient', units='unitless'
        )
        self.add_output(
            'delta_CL', val=0.0, desc='DCL: increment on lift coefficient', units='unitless'
        )
