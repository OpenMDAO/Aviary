...
class CanardWettedArea(om.ExplicitComponent):
    ...
    def compute_partials(self, inputs, J, discrete_inputs=None):
        ...
        J[Aircraft.Canard.WETTED_AREA, Aircraft.Canard.AREA] = scaler * XMULTC

        J[Aircraft.Canard.WETTED_AREA, Aircraft.Canard.THICKNESS_TO_CHORD] = (
            scaler * thickness_to_chord_scaler * area
        )

        J[Aircraft.Canard.WETTED_AREA, Aircraft.Canard.WETTED_AREA_SCALER] = XMULTC * area
