...
def print_report1(nCase, p, nBlades, nflag):
    print()
    print(f"Case {nCase}")
...
if __name__ == "__main__":
    ...
    options.set_val(Aircraft.Design.COMPUTE_INSTALLATION_LOSS,
                        val=True, units='unitless')
    nflag = options.get_val(Aircraft.Design.COMPUTE_INSTALLATION_LOSS)
    prob.setup()
    ...
    print_report1(1, prob, num_blades, nflag)
    prob.run_model()
    print_report2(prob)
    ...
    print_report1(2, prob, num_blades, nflag)
    prob.run_model()
    print_report2(prob)
    ...
    print_report1(3, prob, num_blades, nflag)
    prob.run_model()
    print_report2(prob)
    ...
    print_report1(4, prob, num_blades, nflag)
    prob.run_model()
    print_report2(prob)
    ...
    print_report1(5, prob, num_blades, nflag)
    prob.run_model()
    print_report2(prob)
    ...
    print_report1(6, prob, num_blades, nflag)
    prob.run_model()
    print_report2(prob)
    ...
    print_report1(7, prob, num_blades, nflag)
    prob.run_model()
    print_report2(prob)

    # Case 8
    prob.set_val(Aircraft.Engine.INSTALLATION_LOSS_FACTOR, 0.05, units="unitless")
    print_report1(8, prob, num_blades, nflag)
    prob.run_model()
    print_report2(prob)
    ...
    print_report1(9, prob, num_blades, nflag)
    prob.run_model()
    print_report2(prob)
