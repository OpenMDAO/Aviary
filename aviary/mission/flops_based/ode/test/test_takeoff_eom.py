...
class TakeoffEOMTest(unittest.TestCase):
    ...
    def test_StallSpeed(self):
        ...
        assert_near_equal(prob['stall_speed'], np.array([0.01980571, 0.01400475]), tol)
    ...
    def test_DistanceRates_1(self):
        ...
        prob.model.set_input_defaults(Dynamic.Mission.VELOCITY, np.array([5.23, 2.7]), units='m/s')
    ...
    def test_DistanceRates_2(self):
        ...
        prob.model.set_input_defaults(Dynamic.Mission.VELOCITY, np.array([1.0, 2.0]), units='m/s')
    ...
    def test_Accelerations(self):
        ...
        prob.model.set_input_defaults('forces_horizontal', [100.0, 200.0], units='N')
        ...
        assert_near_equal(prob['acceleration_vertical'], np.array([50.0, 100.0]), tol)
    ...
    def test_FlightPathAngleRate(self):
        ...
        assert_near_equal(
            prob[Dynamic.Mission.FLIGHT_PATH_ANGLE_RATE],
    ...
    def test_SumForcese_1(self):
        ...
        assert_near_equal(prob['forces_vertical'], np.array([9307.0983, 95701.1990]), tol)
    ...
    def test_SumForcese_2(self):
        ...
        assert_near_equal(prob['forces_horizontal'], np.array([-42234.154, -37848.486]), tol)
        assert_near_equal(prob['forces_vertical'], np.array([0.0, 0.0]), tol)
    ...
    def test_ClimbGradientForces(self):
        ...
        assert_near_equal(
            prob['climb_gradient_forces_horizontal'], np.array([-317261.63, 344951.97]), tol
        )
        assert_near_equal(
            prob['climb_gradient_forces_vertical'], np.array([90485.14, 843986.59]), tol
        )
