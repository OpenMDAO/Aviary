...
class BalancedFieldPhaseOptions(AviaryOptionsDictionary):
    def declare_options(self):
        ...
        self.declare(
            ...
            values=['VEF', 'V1', 'VR', 'LIFTOFF', 'V2', 'CLIMB_GRADIENT', 'OBSTACLE', 'STOP'],
            allow_none=True,
            default=None,
...
class BalancedFieldPhaseBuilder(PhaseBuilderBase):
    ...
    def build_phase(self, aviary_options=None):
        ...
        if terminal_condition == 'V1':
            ...
            # )
            # phase.add_boundary_balance(
            #     param='t_duration', name='v_over_v_stall', tgt_val=1.2, loc='final',
            #     lower=-1000, upper=1000, ref=10.
            # )
            pass
            ...
            # before V1.
            phase.add_calc_expr(
                f'v_to_go = velocity - ({VR_RATIO} * v_stall - dV1 - dVEF)',
                velocity={'units': 'kn'},
                dV1={'units': 'kn'},
                v_to_go={'units': 'kn'},
                v_stall={'units': 'kn'},
