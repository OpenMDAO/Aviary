...
class DescentTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prob.model.add_subsystem('group', EOMRates(num_nodes=2), promotes=['*'])
...
class DescentTestCase2(unittest.TestCase):
    ...
    def setUp(self):
        import aviary.mission.two_dof.ode.flight_eom as descent
    ...
    def test_case1(self):
        prob = om.Problem()
        prob.model.add_subsystem('group', EOMRates(num_nodes=2), promotes=['*'])
...
class ClimbTestCase2(unittest.TestCase):
    ...
    def setUp(self):
        import aviary.mission.two_dof.ode.flight_eom as climb
