...
class GammaComp(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input(
            'dh_dr', shape=nn, units='m/distance_units', desc='change in altitude wrt range'
        )

        self.add_input(
            'd2h_dr2',
            shape=nn,
            units='m/distance_units**2',
    ...
    def setup_partials(self):
        ...
        self.declare_partials(of=Dynamic.Mission.FLIGHT_PATH_ANGLE, wrt='dh_dr', rows=ar, cols=ar)
    ...
    def compute_partials(self, inputs, partials):
        ...
        partials['dgam_dr', 'd2h_dr2'] = 1.0 / (dh_dr**2 + 1)
