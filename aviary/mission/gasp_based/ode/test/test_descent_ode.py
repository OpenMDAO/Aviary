...
class DescentODETestCase(unittest.TestCase):
    ...
    def test_high_alt(self):
        ...
        self.prob.set_val(
            Dynamic.Atmosphere.ALTITUDE, np.array([36500, 14500]), units="ft"
        )
        ...
        testvals = {
            ...
            # ft/s
            Dynamic.Atmosphere.ALTITUDEUDE_RATE: np.array([-2356.7705, -2877.9606])
            / 60,
    ...
    def test_low_alt(self):
        ...
        self.prob.set_val(Dynamic.Atmosphere.ALTITUDE, 1500, units="ft")
        ...
        testvals = {
            ...
            "CL": 0.507578,
            "CD": 0.0268404,
            Dynamic.Atmosphere.ALTITUDEUDE_RATE: -1138.583 / 60,
