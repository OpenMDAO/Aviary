...
class FuelBurnTestCases(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prob.aviary_inputs.set_val(Mission.Takeoff.FUEL_MASS, val=0, units='lbm')
    ...
    def test_mission_fuel_burned(self):
        ...
        fuel_burned = self.prob.get_val(Mission.FUEL_MASS, units='lbm')
        block_fuel = self.prob.get_val(Mission.BLOCK_FUEL_MASS, units='lbm')
    ...
    def test_takeoff_fuel_burned(self):
        self.prob.aviary_inputs.set_val(Mission.Takeoff.FUEL_MASS, val=500, units='lbm')
    ...
    def test_taxi_out_fuel_burned(self):
        self.prob.aviary_inputs.set_val(Mission.Taxi.FUEL_MASS_TAXI_OUT, val=200, units='lbm')
    ...
    def test_taxi_in_fuel_burned(self):
        self.prob.aviary_inputs.set_val(Mission.Taxi.FUEL_MASS_TAXI_IN, val=100, units='lbm')
