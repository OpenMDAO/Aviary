...
def update_gasp_options(vehicle_data, verbosity=Verbosity.BRIEF):
    ...
    if (
        ...
        max_cargo, units = input_values.get_item(Aircraft.CrewPayload.Design.MAX_CARGO_MASS)
        input_values.set_val(Aircraft.CrewPayload.Design.MAX_CARGO_MASS, max_cargo, units)
        input_values.set_val(Aircraft.CrewPayload.CARGO_MASS, 0, units)
        input_values.set_val(Aircraft.CrewPayload.Design.MAX_CARGO_MASS, 0, units)
