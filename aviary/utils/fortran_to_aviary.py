...
def update_gasp_options(vehicle_data, verbosity=Verbosity.BRIEF):
    ...
    if reserve_fuel_additional <= 0:
        ...
        input_values.set_val(Aircraft.Design.RESERVE_FUEL_MARGIN, [-reserve_fuel_additional], units='lbm')
    ...
    reserve_fuel_volume = input_values.get_val(
        Aircraft.Fuel.VOLUME_MARGIN, units='unitless')[0]
    if reserve_fuel_volume < 0:
        ValueError('"FVOL_MRG" is not valid below 0. Cannot set fuel volume reserves to less than zero')# 
