...
@use_tempdirs
class CommandEntryPointsTestCases():
...
class fortran_to_aviaryTestCases(CommandEntryPointsTestCases):
    def xxxnorundiff_configuration_conversion(self):
    ...
    def xxxnorunsmall_single_aisle_conversion(self):
    ...
    def xxxnorunFLOPS_conversion(self):
        filepath = get_aviary_resource_path(
    ...
    def xxxnorunforce_conversion(self):
        filepath = get_aviary_resource_path(
            'models/aircraft/small_single_aisle/small_single_aisle_GASP.dat'
        )
...
class convert_engineTestCases(CommandEntryPointsTestCases):
    def xxxnorunGASP_conversion(self):
    ...
    def xxxnorunGASP_TS_conversion(self):
