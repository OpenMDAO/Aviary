...
Aviary comes with [multiple examples of external subsystems](../user_guide_unreviewed/subsystems/using_external_subsystems) that can be used to create medium- and high-fidelity models.
