...
class Aircraft:
    ...
    class Engine:
        ...
        INSTALLATION_LOSS_FACTOR = 'aircraft:engine:installation_loss_factor'
        ...
        PROPELLER_ACTIVITY_FACTOR = 'aircraft:engine:activity_factor'
        ...
        PROPELLER_TIP_SPEED = 'aircraft:engine:propeller_tip_speed'
