...
class Aircraft:
    ...
    class Wing:
        ...
        ENGINE_POSITION_MASS_SCALER = 'aircraft:wing:engine_position_mass_scaler'
        ...
        REFERENCE_CLEAN_MAX_LIFT_COEFFICIENT = 'aircraft:wing:reference_clean_max_lift_coefficient'
