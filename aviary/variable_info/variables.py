...
class Aircraft:
    ...
    class Fuel:
        ...
        WING_CAPACITY_TERM_EXPONENTIAL = 'aircraft:fuel:wing_capacity_term_exponential'
        WING_CAPACITY_TERM_LINEAR = 'aircraft:fuel:wing_capacity_term_linear'
        WING_FUEL_FRACTION = 'aircraft:fuel:wing_fuel_fraction'
        WING_FUEL_MASS_CAPACITY = 'aircraft:fuel:wing_fuel_mass_capacity'
        WING_REFERENCE_AREA = 'aircraft:fuel:wing_reference_area'
        WING_REFERENCE_CAPACITY = 'aircraft:fuel:wing_reference_capacity'
