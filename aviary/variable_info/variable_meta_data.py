...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.7
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 2.0
    units="lbm",
...
add_meta_data(
    ...
    default_value=1.0,  # changed from 23.0
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed form None
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.18
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.10
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.16
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.0862
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.85
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.2
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.22
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.333
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.15
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.9
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 0.404
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed form 3.75
)
...
add_meta_data(
    ...
    default_value=0.0,  # changed from 3.0
)
