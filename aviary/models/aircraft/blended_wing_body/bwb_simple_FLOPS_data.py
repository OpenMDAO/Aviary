...
# Horizontal Tail
# ---------------------------
inputs.set_val(Aircraft.HorizontalTail.AREA, 0.01, 'ft**2')  # SHT in bwb.in, set to 0.01 not 0.0
...
inputs.set_val(Aircraft.Engine.NUM_FUSELAGE_ENGINES, np.array([3]))  # NEF in bwb.in
...
outputs.set_val(Aircraft.Design.OPERATING_MASS, 455464.65969526308, 'lbm')  # WOWE
