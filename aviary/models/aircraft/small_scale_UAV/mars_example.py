...
print('Lift balance residual:', round(prob.get_val( 'traj.phases.cruise.rhs_all.lift_balance_residual', units='N')[0], 3))
...
print('Fuel mass (should be zero):', round(prob.get_val('mission:total_fuel_mass', units='kg')[0], 3))