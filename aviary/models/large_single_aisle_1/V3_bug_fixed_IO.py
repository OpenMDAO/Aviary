...
V3_bug_fixed_options.set_val(Aircraft.Wing.FOLD_DIMENSIONAL_LOCATION_SPECIFIED,
                             val=True, units='unitless')
V3_bug_fixed_options.set_val(
    Aircraft.Strut.DIMENSIONAL_LOCATION_SPECIFIED, val=True, units='unitless')
V3_bug_fixed_options.set_val(Aircraft.LandingGear.FIXED_GEAR,
                             val=False, units='unitless')
...
V3_bug_fixed_options.set_val(
    Aircraft.Fuselage.NUM_SEATS_ABREAST, 6, units="unitless"
)
V3_bug_fixed_options.set_val(
    Aircraft.Fuselage.SEAT_WIDTH, 20.2, units="inch"
)
V3_bug_fixed_options.set_val(
    Aircraft.Fuselage.NUM_AISLES, 1, units="unitless"
)
V3_bug_fixed_options.set_val(
    Aircraft.Fuselage.AISLE_WIDTH, 24, units="inch"
)
V3_bug_fixed_options.set_val(
    Aircraft.Fuselage.SEAT_PITCH, 29, units="inch"
)
V3_bug_fixed_options.set_val(
...
V3_bug_fixed_options.set_val(
    ...
    Aircraft.Wing.HIGH_LIFT_MASS_COEFFICIENT, val=2.66, units='unitless'
)
V3_bug_fixed_options.set_val(
...
V3_bug_fixed_options.set_val(
    Aircraft.Wing.FLAP_CHORD_RATIO, val=0.3, units='unitless'
)
