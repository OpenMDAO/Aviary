...
engine_inputs.set_val(Aircraft.Engine.WING_LOCATIONS, 0.28131)
...
outputs.set_val(Aircraft.Design.EMPTY_MASS, 88507., 'lbm')
outputs.set_val(Aircraft.Design.EMPTY_MASS_MARGIN, 452.6, 'lbm')
outputs.set_val(Aircraft.Design.TOUCHDOWN_MASS, 146328.0, 'lbm')
outputs.set_val(Aircraft.Design.OPERATING_MASS, 95267., 'lbm')
outputs.set_val(Aircraft.Propulsion.MASS, 19232., 'lbm')
outputs.set_val(Aircraft.Design.STRUCTURE_MASS, 44648., 'lbm')
outputs.set_val(Aircraft.Design.SYSTEMS_EQUIP_MASS, 24174., 'lbm')
outputs.set_val(Aircraft.Design.TOTAL_WETTED_AREA, 8319.07, 'ft**2')
outputs.set_val(Aircraft.Design.ZERO_FUEL_MASS, 131744., 'lbm')
outputs.set_val(Mission.Design.FUEL_MASS, 42456., 'lbm')
...
outputs.set_val(Aircraft.Fuselage.MASS, 16790., 'lbm')
...
outputs.set_val(
    Aircraft.LandingGear.MAIN_GEAR_MASS, 0.0117 * 146328.0**0.95 * 84.0**0.43, 'lbm')
outputs.set_val(
    Aircraft.LandingGear.NOSE_GEAR_MASS, 0.048 * 146328.0**0.67 * 58.8**0.43, 'lbm')
...
dist_count_factor = num_engines

engine_ctrls_mass = 0.26 * dist_count_factor * dist_thrust_factor**0.5  # 85.92
...
outputs.set_val(Aircraft.Wing.SURFACE_CONTROL_MASS, 1835., 'lbm')
