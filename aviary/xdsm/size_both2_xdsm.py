"""
This XDSM is for the case with a fold and a strut, fold location not based on strut
location. It also is the case where tail volume coefficients ARE computed.
"""
...
x.write("size_both2_xdsm")
x.write_sys_specs("size_both2_specs")
