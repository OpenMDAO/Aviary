"""This XDSM is for the case with no fold and no strut"""
...
HAS_FOLD = False
HAS_STRUT = False
compute_volume_coeff = True  # see empennage_size_xdsm.py
...
if HAS_FOLD:
    ...
    wing_inputs.append(r"\textcolor{gray}{"+Aircraft.Fuel.WING_FUEL_FRACTION+"}")
if HAS_STRUT:
...
if HAS_STRUT:
    ...
    wing_outputs.append("strut.strut_y")
x.add_output("wing", wing_outputs, side="right")

x.add_system("empennage", GROUP, ["EmpennageSize"])
...
if compute_volume_coeff:
    ...
    emp_inputs.append(r"\textcolor{gray}{"+Aircraft.VerticalTail.VOLUME_COEFFICIENT+"}")
...
x.write("size_basic_xdsm")
x.write_sys_specs("size_basic_specs")
