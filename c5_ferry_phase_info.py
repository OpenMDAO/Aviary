phase_info = {
    ...
    "climb_1": {
        ...
        "user_options": {
            ...
            "final_altitude": (26000.0, "ft"),
            "altitude_bounds": ((0.0, 26500.0), "ft"),
    ...
    "climb_2": {
        ...
        "user_options": {
            ...
            "initial_altitude": (26000.0, "ft"),
            "final_altitude": (28000.0, "ft"),
            "altitude_bounds": ((25500.0, 28500.0), "ft"),
            "throttle_enforcement": "boundary_constraint",
            "fix_initial": False,
            "constrain_final": False,
            "fix_duration": False,
            "initial_bounds": ((25.0, 75.0), "min"),
            "duration_bounds": ((225.0, 675.0), "min"),
        },
        "initial_guesses": {"time": ([50.0, 450.0], "min")},
    },
    "descent_1": {
        "subsystem_options": {"core_aerodynamics": {"method": "computed"}},
        "user_options": {
        ...
        "initial_guesses": {"time": ([500.0, 20.0], "min")},
    },
    "post_mission": {
        "include_landing": False,
        "constrain_range": True,
        "target_range": (4158.78, "nmi"),
    },
}
